...
HD_PWD='C:/Users/Campo/Documents/VGA-Controller/VGA-Controller.runs/clk_25MHz_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_25MHz.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_25MHz.tcl
