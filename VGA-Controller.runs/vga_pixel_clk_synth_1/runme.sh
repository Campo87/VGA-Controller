...
HD_PWD='C:/Users/James/Documents/GitHub/VGA-Controller/VGA-Controller.runs/vga_pixel_clk_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_pixel_clk.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_pixel_clk.tcl
