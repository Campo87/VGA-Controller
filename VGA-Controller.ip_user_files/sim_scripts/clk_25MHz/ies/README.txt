...
#
# Generated by export_simulation on Wed Aug 19 16:35:31 -0500 2020
#
################################################################################
...
'-reset_run' switch to the './clk_25MHz.sh' script.

./clk_25MHz.sh -reset_run
...
./clk_25MHz.sh -noclean_files

For more information on the script, please type './clk_25MHz.sh -help'.
